...
untuk mengakses gunakan transform
    ...
    public KinematicData getSteering()
    {
        ...
        //lengkapi line code dibawah ini dan hilangkan sintax "//"
        _KinematicOut._velocity = -_target.position + this.transform.position ; //#direction, lihat code seek , flee merupakan direction yang berlawanan dengan seek
